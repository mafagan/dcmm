...
BROKER_CFLAGS:=-I. -I.. ${CPPFLAGS} -DVERSION="\"${VERSION}\"" -DTIMESTAMP="\"${TIMESTAMP}\"" -DWITH_BROKER
...
CLIENT_LDFLAGS:=$(LDFLAGS) -L../lib ../lib/libmosquittodcmm.so.${SOVERSION}
...
ifneq ($(UNAME),SunOS)
	LIB_LDFLAGS:=$(LIB_LDFLAGS) -Wl,--version-script=linker.version -Wl,-soname,libmosquittodcmm.so.$(SOVERSION)
endif
